...
<?php
 ...
 #   <li class="dropdown">
  ...
  <div class='modal-content'>
   ...
   Email: <a href='mailto:$email'>$email</a><br><br><br><br><br>";
   if($uname!=$uuname)
   {
  echo  "<a href='chat_check.php?fname=$uuname' class='btn btn-default'>Send message</a><br><br>";
 }
   
 echo "<!--<form style='align:left;' method='post' id='msg_form'>
