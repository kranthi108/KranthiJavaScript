  ...
  <div class="container">
    ...
    <div id="sidebar-wrapper" class="sidebar-toggle">
      <ul class="sidebar-nav" style="text-align: left;">
          ...
          <li>
              <a href="aoi.php">Area of interests</a>
          </li>
          <li>
...
$i++;
        ...
        #$msg=mysqli_error($conn);
                            ...
                            echo "<center><table border=1px width=50% style='width: 800px; padding:10px; border: 5px solid gray; margin: 0; background-color: white; box-shadow:15px 15px; border-radius: 25px;' >";
                              ...
                              echo "<form method= 'Post' action='post.php' enctype='multipart/form-data'>
  <div class='form-group'>
    ...
    <textarea type='text' class='form-control' id='Description' aria-describedby='Description' placeholder='Description of the project' name='description' required></textarea>
