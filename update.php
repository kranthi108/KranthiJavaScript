            ...
            <div class='container-fluid'>
              ...
              <div class='collapse navbar-collapse' id='myNavbar'>
                <ul class='nav navbar-nav'>
                  ...
                  <li><a style="color:black;" href='myprojects.php'>Projects</a></li>
                    ...
                    <tr> -->
                      ...
                      <?php
                            ...
                            if($result->num_rows == 0) {
                              ...
                              echo "<br><br><br><br><br><br><center><div class='transparentbox' <h6> WELCOME  ".$username."</h6><br><br><br>
                            <p>You have no own project to display here. post new projects for updating or modifying them <p></div></center><br><br><br><br><br><br>";
                              ...
                              // echo '<tr>'.'<th>name</th>'.'<th>pid</th>'.'<th>field</th>'.'<th>description</th></tr>';
                                while($row = mysqli_fetch_assoc($result))
                                {
                                  ...
                                  echo "<tr style='background:#00b0ff;'>"."<td style=' padding:10px 10px;'>"."<h3>"."<a href='uppro.php?pid=$pid'> <h3>".$row["name"]."</h3></a>"."</h3>"."</td>"."</tr>"."<br>"."<tr>"."<td style= 'padding:10px 10px;'>"."<h4>".$body."</h4>"."</td>"."</tr>"."<hr><tr>"."<td><h6>&nbsp tags:".$row["field"]." &nbspPosted on:&nbsp".$row["pdate"];
                                    if($_SESSION["user"]!=NULL)
                                    {
...
$i++;
      ...
      if(in_array($file_ext,$expensions)=== false){
         $errors[]="<br><br><br>file not choosen, please choose allowed file.";
      }
      
      if($file_size > 2097152) {
         $errors[]='<br><br><br>File size must be less than 2 MB';
      }
      ...
      if(empty($errors)==true) {
         ...
         echo "<br><br>error in uploading file  ".print_r($errors);
      }
   }
                                  ...
                                  if($result2)
                                  {
                                    ...
                                    if($result3)
                                    {
                                      echo "<br><br><br><br>Project added successfully";
