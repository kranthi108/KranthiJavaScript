      ...
      if(empty($errors)==true) {
                             ...
                             else
                             {
                              ...
                              // echo '<tr>'.'<th>name</th>'.'<th>pid</th>'.'<th>field</th>'.'<th>description</th></tr>';
                                while($row = mysqli_fetch_assoc($result1))
                                {
                                  ...
                                  echo "<tr>"."<td>"."<h3>".$row["name"]."</h3>"."</td>"."</tr>"."<br>"."<tr>"."<td>"."<h4>".$row["description"]."</h4>"."</td>"."</tr>"."<tr>"."<td><h6>&nbsp tags:".$row["field"]." &nbspPosted on:&nbsp".$row["pdate"];
                                    if($_SESSION["user"]!=NULL)
                                    {
        ...
        #$msg=mysqli_error($conn);
                            ...
                            if ($result->num_rows > 0) {
                              ...
                              echo "<form action='project_update.php' method= 'Post' enctype='multipart/form-data'>
                              <div class='form-group'>
