...
<body>
 ...
 #   <li class="dropdown">
  ...
  <div class="container">
    ...
    <div id="sidebar-wrapper" class="sidebar-toggle">
      <ul class="sidebar-nav" style="text-align: left;">
          <li>
              <a href="admin.php?option=see_projects">See all the projects</a>
          </li>
          <li>
              <a href="admin.php?option=Add">Add New Fields</a>
          </li>
          <li>
              <a href="chat.php">Message</a>
          </li>
          <li>
              <a href="admin.php?option=see_users">See all the users</a>
          </li>
        </ul>
    </div>
    </div>
                      ...
                      <?php
                          ...
                          if($option=='see_users'){
                              ...
                              $sql1="select distinct * from user";
                                  ...
                                  echo "<img style= 'border-radius:50%; width:20%; height:120px; align:left;' src='$photo'>
                                         Author: $fname $lname <br><br>
                                         Email: <a href='mailto:$email'>$email</a><br>
                                         <a style='float: right;' href='admin.php?del=$usname & option=deel' class='btn btn-default'>Delete user</a><br><br><br><hr>";
                                  }
                                }
                                
                                else if($option=='deel'){
                                  $usname=$_GET['del'];
                                  $sql1="delete from user where uname='$usname';";
                                  $result1=mysqli_query($conn,$sql1);
                                  if($result1)
                                  {
                                    echo "<center><br><br>User Deleted Successfully</center>";
                                    $sql1="select distinct * from user";
                                  $result1=mysqli_query($conn,$sql1);
                                  echo "<br><br>";
                                  while($row1=mysqli_fetch_assoc($result1))
                              ...
                              else if($option=='Add')
                            {
                              ...
                              if($aoi!='')
                              {
                                $sql="insert into areaofinterest(area) value('$aoi');";
                                $result=mysqli_query($conn,$sql);
                                if($result)
                                {
                                  echo "<center><br><br> $aoi field added Successfully</center>";
                                }
                                else
                                {
                                  echo "<center><br><br><font color='red'> Error occurred!! in adding $aoi field <font color='default'> </center>";
                                }

                              }
                              $sql1="select * from areaofinterest order by aoi_id asc;";
                              $result1=mysqli_query($conn,$sql1);
                              echo "<br><br><fieldset><legend>Area of Interest</legend>";
                              ...
                              <input type='text' placeholder='Enter New Field' name='aoi' required><br><br>
                              <input type='submit' value='Add to the field' name='option'></form></fieldset><br><br><br>";
                            }


                            else if($option=='see_projects')
                            {
  ...
  <div class='modal-content'>
   ...
   <img style= 'border-radius:50%; width:20%; height:120px; align:left;' src='$photo'>
   Author: $fname $lname <br><br>
   Email: <a href='mailto:$email'>$email</a><br>
   <a href='chat_check.php?fname=$uuname'>Send Message</a>
...
$i++;
                            ...
                            {
                              echo "<br><br><br><br><br><br><center><div class='transparentbox' <h6> WELCOME ADMIN</h6><br><br><br>
                            <p>check the database for any updates or user details that were recently added or updated <p></div></center><br><br><br><br><br><br>";
                            }
