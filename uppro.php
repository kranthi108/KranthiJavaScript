  ...
  <div class="container">
    ...
    <div id="sidebar-wrapper" class="sidebar-toggle">
      ...
      if(in_array($file_ext,$expensions)=== false){
         $errors[]="<br><br>extension not allowed, please choose allowed file.";
      }
      
      if($file_size > 2097152) {
         $errors[]='<br><br><br>File size must be excately 2 MB';
      }
      ...
      if(empty($errors)==true) {
         ...
         echo "<br><br><br>error in uploading file  ".print_r($errors);
      }
   }
                          if($location==''){
                             ...
                             {
                              $sql="update store set name='$title',field='$field',description='$description',status='$status',file='$location' where pid='$pid';";
                             }
...
$i++;
        ...
        #$msg=mysqli_error($conn);
                            ...
                            if ($result->num_rows > 0) {
                              ...
                              echo "<form action='uppro.php' method= 'Post' enctype='multipart/form-data'>
                              <div class='form-group'>
  ...
  <div class='form-group'>
    ...
    <input type='file' name='fileToUpload' class='form-control-file' id='exampleInputFile' aria-describedby='fileHelp'><a href='$loc'> &nbsp &nbsp View/Download</a>
    <small id='fileHelp' class='form-text text-muted'>Previous file</small>
  </div>
