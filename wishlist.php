  ...
  <div class="container">
    ...
    <div id="sidebar-wrapper" class="sidebar-toggle">
      <ul class="sidebar-nav" style="text-align: left;">
          <li>
              <a href="post.php">Post new project</a>
          </li>
          <li>
          ...
          <li>
              <a href="addto.php">Add projects to wishlist</a>
          </li>
        </ul>
    </div>
    </div>
                  ...
                  <tbody>
                    <tr> -->
                      ...
                      <?php
                            ...
                            $s = "INSERT INTO wishlist (uname,pid) VALUES('$username','$m');";
                            $sql_s=mysqli_query($conn,$s);
                            $sql = "SELECT DISTINCT * FROM store,wishlist where store.pid=wishlist.pid and uname='$username';";
                            $result = mysqli_query($conn,$sql);

			                       if($result->num_rows == 0) {

                              echo "<br><br><br><br><br><br><center><div class='transparentbox' <h6> WELCOME  ".$username."</h6><br><br><br>
                            <p>You have not created any wishlist by your own to display here. create a new wishlist by clicking add to wishlist option provided by the user in project description <p></div></center><br><br><br><br><br><br>";
