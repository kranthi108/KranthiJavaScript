...
<body>
 ...
 <li>  <a href='#'>Edit Profile</a></li>
     ...
     <li> <form action='messages.php' method='post'><input type='Submit' value='Messages' name='option'></form></li>
          ...
          <div class='container-fluid text-center'>    
            <div class='row content'>
              ...
              <br><br>
                ...
                <p> <form action='messages.php' method='post'><input type='Submit' value='Messages' name='option'></form></p><br><br>
                  ...
                  <tbody>
                    <tr> -->
                      <?php
                            ...
                            $usid=$_SESSION["user"];
			                      $sql = "SELECT distinct uname,fname,lname FROM user where uname IN((Select sendid from message where recid='$usid')) or uname IN((Select recid from message where sendid='$usid'));";
			                      $result = mysqli_query($conn,$sql);
                          # echo $usid;
			                      if ($result->num_rows > 0) {
			           			      
                               echo "<center>Recent messages<br></center>";
                              // echo '<tr>'.'<th>name</th>'.'<th>pid</th>'.'<th>field</th>'.'<th>description</th></tr>';
                                while($row = mysqli_fetch_assoc($result))
                                {
                                 ...
                                 # echo $row["uname"],$row["fname"],$row["lname"];
                                  $name=$row["fname"]." ".$row["lname"];
                                  echo "<center><form action='messages.php' method='post'><input type='submit' value='$name' name='msg_rec'></form><br></center>";
                                }
                    ...
                    <div class='container'>
                      <div class='row'>
                        <div class='col-md-4 col-sm-6 footerleft '>
                          ...
                          <p><i class='fa fa-map-pin'></i> #135, pg2 hostel, NITC hostels, Calicut -110085, INDIA</p>
