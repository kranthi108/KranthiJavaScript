...
if(isset($_FILES['image'])){
   ...
   # $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    {
        #echo "Success<br>";
    $sql_m="insert into message(sendid,recid,message) values('admin','$uname','Hi $fname $lname,Welcome to NITC EDUCENTER');";
    ...
    echo "<div class='container'>
            <form class='form-horizontal' role='form' method='Post' action = '' enctype = 'multipart/form-data'>
                ...
                <div class='form-group'>
                    ...
                    <label for='birthDate' class='col-sm-3 control-label'>Date of Birth(yyyy-mm-dd)</label>
                    <div class='col-sm-9'>
                        <input type='date' id='datepicker' name='dob' class='form-control' required>
